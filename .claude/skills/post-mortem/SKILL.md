...
Engineer-to-engineer record. Not the version that goes to leadership:
...
What this engineering post-mortem captures that a leadership-flavored update wouldn't:
...
- **Never strip code identifiers** in the engineering record. They are the index. A leadership-flavored reframe is a separate concern, not this skill's.
