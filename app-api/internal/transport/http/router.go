...
func RegisterRoutes(app *fiber.App, healthHandler health.Handler, authHandler authhttp.Handler, workspaceHandler workspacehttp.Handler, projectHandler projecthttp.Handler, taskHandler taskhttp.Handler) {
